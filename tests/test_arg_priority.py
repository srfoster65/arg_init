...
class TestDefaultConfig:
    ...
    @pytest.mark.parametrize(
        "prefix, arg, arg_value, envs, expected",
        [
            # No Arg defined
            (None, None, "arg1_value", {"ARG1": "env_1value"}, Expected("arg1", "arg1_value")),
            (None, None, None, {"ARG1": "env1_value"}, Expected("arg1", "env1_value")),
    ...
    def test_matrix(self, prefix, arg, arg_value, envs, expected):
        """
