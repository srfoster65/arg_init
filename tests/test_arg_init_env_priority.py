...
class TestDefaultConfig:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # No Arg defined
            (None, None, "arg_value", {}, Expected("arg", "arg_value")),
            (None, None, "arg_value", {"ARG": "env_value"}, Expected("arg", "env_value")),
            (None, None, None, {}, Expected("arg", None)),

            # Use arg
            (None, Arg("arg", None, None, None, False, False, True, False), "arg_value", {}, Expected("arg", "arg_value")),
            (None, Arg("arg", None, "default", None, False, False, True, False), "arg_value", {}, Expected("arg", "arg_value")),
            (None, Arg("arg", None, "default", "new_arg", False, False, True, False), "arg_value", {}, Expected("new_arg", "arg_value")),
            (None, Arg("arg", None, "default", None, True, False, True, False), None, {}, Expected("arg", None)),

            # Use env
            (None, Arg("arg", None, None, None, False, False, True, False), None, {"ARG": "env_value"}, Expected("arg", "env_value")),
            (None, Arg("arg", "arg", None, None, False, False, True, False), "arg_value", {"ARG": "env_value"}, Expected("arg", "env_value")),
            (None, Arg("arg", "foo", None, None, False, False, True, False), "arg_value", {"foo": "env_value"}, Expected("arg", "env_value")),
            ("prefix", Arg("arg", None, None, None, False, False, True, False), "arg_value", {"PREFIX_ARG": "env_value"}, Expected("arg", "env_value")),
            ("prefix", Arg("arg", "arg", None, None, False, False, True, False), "arg_value", {"PREFIX_ARG": "env_value"}, Expected("arg", "env_value")),
            ("prefix", Arg("arg", "foo", None, None, False, False, True, False), "arg_value", {"PREFIX_FOO": "env_value"}, Expected("arg", "env_value")),
            (None, Arg("arg", None, "default", None, False, True, False, False), "arg_value", {"ARG": ""}, Expected("arg", "")),
    ...
    def test_matrix(self, prefix, param, arg_value, envs, expected):
        ...
        def _test(arg=None):
            ...
            return ArgInit(env_prefix=prefix, priority=ArgInit.ENV_PRIORITY).go(params).args
